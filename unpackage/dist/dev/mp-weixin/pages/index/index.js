...
try {
  components = {
    foodList: function() {
      return __webpack_require__.e(/*! import() | components/food-list/food-list */ "components/food-list/food-list").then(__webpack_require__.bind(null, /*! @/components/food-list/food-list.vue */ 43))
    }
  }
} catch (e) {
  if (
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var foodList = function foodList() {__webpack_require__.e(/*! require.ensure | components/food-list/food-list */ "components/food-list/food-list").then((function () {return resolve(__webpack_require__(/*! ../../components/food-list/food-list.vue */ 43));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
